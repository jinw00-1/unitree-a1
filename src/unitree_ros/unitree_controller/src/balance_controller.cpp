...
public:
    ...
    void imuCallback(const sensor_msgs::Imu & msg) { 
        ...
        // quaternion > euler
        quaternionToEuler(msg.orientation.w, msg.orientation.x, msg.orientation.y, msg.orientation.z, roll, pitch, yaw);
    ...
    sensor_msgs::Imu getCurrentIMU() const {
        return current_imu;
    }
...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle n;
    ros::Publisher lowState_pub = n.advertise<unitree_legged_msgs::LowState>("/" + robot_name + "_gazebo/lowState/state", 1);
    ...
    while (ros::ok()) {
        ...
        control logic
        */
        double pitch = listen_publish_obj.getPitch();
        balance_motion_init(pitch);
